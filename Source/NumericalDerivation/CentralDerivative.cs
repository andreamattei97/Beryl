...
namespace Beryl.NumericalDerivation
{
    ...
    public class CentralDerivative
    {
        ...
        /// <summary>
        /// <para>Provides a generator for numerical derivatives based on central finite differences of given order and step.</para> 
        /// </summary>
        /// <param name="step">The step of the finite differences</param>
        ...
        /// <summary>
        /// <para>Provides a generator for numerical first derivatives based on central finite differences of the given step.</para> 
        /// </summary>
        ...
        /// <summary>
        /// <para>Provides a generator for numerical derivatives based on central finite differences of the default step.</para> 
        /// </summary>
        /// <param name="step">The step used by the generator</param>
        /// <param name="order">The order of the generated derivatives</param>
        /// <returns>The generator of numerical derivatives of the given step and order</returns>
        ...
        /// <summary>
        /// <para>Provides a generator for numerical first derivatives based on central finite differences of the default step.</para> 
        /// </summary>
        /// <param name="step">The step used by the generator</param>
        /// <param name="order">The order of the generated derivatives</param>
        /// <returns>The generator of numerical derivatives of the given step and order</returns>
