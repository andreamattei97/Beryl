...
namespace Beryl.NumericalDerivation
{
    ...
    class CentralDerivative
    {
        ...
        {
            CentralDerivative derivative = new CentralDerivative(function, order, step);
        ...
        public double Step
        {
            ...
            {
                if (value <= 0)
                    throw new ArgumentOutOfRangeException("Step", "The step of the derivative must be positive");
                _step = value;
            }
        }
        ...
        public CentralDerivative(Func<double,double> function,int order,double step)
        {
            Order = order;
            Step = step;
