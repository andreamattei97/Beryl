...
{
    /// <summary>
    /// Numerical derivative based on backward finite difference
    /// </summary>
    /// <remarks>
    /// <para>This class serves for generating a function that estimates the derivative through backward finite differences.</para>
    ...
    public class BackwardDerivative
    {
        ...
        /// <summary>
        /// <para>Provides a generator for numerical derivates based on backward finite differences of given order and step.</para> 
        /// </summary>
        ...
        /// <summary>
        /// <para>Provides a generator for numerical derivates based on backward finite differences of the default order and step.</para> 
        /// <para>For default parameters check <see cref="DefaultNumericalDerivationParameters"/></para>
        /// </summary>
        /// <param name="step">The step used by the generator</param>
        /// <returns>The generator of numerical derivatives of the given step and order</returns>
