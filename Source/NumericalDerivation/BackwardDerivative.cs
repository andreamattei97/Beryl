...
namespace Beryl.NumericalDerivation
{
    ...
    /// </summary>
    /// <remarks>
    /// <para>This class serves for generating a function that estimates the derivative through central finite differences of uniform step.</para>
    ...
    /// </remarks>
    public class BackwardDerivative
    {
        ...
        /// <summary>
        /// <para>Provides a generator for numerical derivatives based on backward finite differences of given order and step.</para> 
        /// </summary>
        /// <param name="step">The step of the finite differences</param>
        ...
        /// <summary>
        /// <para>Provides a generator for numerical first derivatives based on backward finite differences of the given step.</para> 
        /// </summary>
        ...
        /// <summary>
        /// <para>Provides a generator for numerical derivatives based on backward finite differences of the default step.</para> 
        /// </summary>
        /// <param name="step">The step used by the generator</param>
        /// <param name="order">The order of the generated derivatives</param>
        /// <returns>The generator of numerical derivatives of the given step and order</returns>
        ...
        /// <summary>
        /// <para>Provides a generator for numerical first derivatives based on backward finite differences of the default step.</para> 
        /// </summary>
        /// <param name="step">The step used by the generator</param>
        /// <param name="order">The order of the generated derivatives</param>
        /// <returns>The generator of numerical derivatives of the given step and order</returns>
