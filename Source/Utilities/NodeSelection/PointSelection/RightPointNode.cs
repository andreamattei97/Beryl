...
{
    public class RightPointNode:PointNode
    {
        public readonly double Interval;

        public RightPointNode(StepPoint stepPoint, double interval) : this(stepPoint, interval, new StepPoint[0]) { }

        public RightPointNode(StepPoint stepPoint, double interval, StepPoint[] previousPoints) : base(stepPoint.Coordinates)
        {
