...
namespace Beryl.ODE
{
    ...
    public class RungeKuttaSolver : SinglestepODESolver
    {
        ...
        private RungeKuttaSolver(ODEFunction function, Point2D initialPoint, IDiscretizer discretizer, int maxIterations) : base(function, initialPoint, discretizer, maxIterations)
        {
        }
        ...
        private RungeKuttaSolver(ODEFunction function, Point2D initialPoint, IDiscretizer discretizer, IODEOptimizer optimizer, int maxIterations) : base(function, initialPoint, discretizer, optimizer, maxIterations)
        {
        }
        ...
        protected override Point2D Iteration(StepPoint point)
        {
            ...
            return new Point2D(point.Coordinates.x + point.Step, point.Coordinates.y + point.Step / 6 * (K1 + 2 * K2 + 2 * K3 + K4)); 
        }
